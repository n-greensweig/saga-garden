...
1. Add `redux-sagas` to the project to make an API request. The route `http://localhost:5001/api/plant` returns an array of plants. Display that array on the `PlantList` component on load.
